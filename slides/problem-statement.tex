...
\begin{frame}{Problem statement}
  ...
  \end{card}
  \pdfcomment{
    Thus, our overall goal is to Extend common aggregate computing paradigm including the Machine Learning capability to improve adaptability and simplify the definition and refinement of collective behaviour. 
  }
\end{frame}