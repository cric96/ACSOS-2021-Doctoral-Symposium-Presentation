...
\begin{frame}{Gradient/Hop count example}
  ...
  \begin{multicols}{3}
    ...
    \cardImg{img/slow-rising-problem-1}{0.31\textwidth}
    \cardImg{img/slow-rising-problem-2}{0.31\textwidth}
  \end{multicols}
  \pause[3]
  \pdfcomment{
    ...
    This is already done algorithmically, but we need something that learns how to achieve 
    faster convergence on its own.
  }
\end{frame}