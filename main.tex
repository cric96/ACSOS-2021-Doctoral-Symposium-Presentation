...
\begin{frame}{Background}
  ...
  \pdfcomment{
    ...
    So the collective to exhibit robust behaviour while achieving system-wide and agent-specific goals.
...
\begin{frame}{Early results}
  \pdfcomment {
    So, speaking about the early work and results, we mainly try to:
...
\begin{frame}{Aggregate Computing and Supervised Learning}
  \pdfcomment{
    ...
    We do some experiments in this direction. We note that it is challenging to achieve
